        ...
        <div class="container-fluid padding-25 sm-padding-10">
          <div class="row">
            <div class="col-xlg-10">
              ...
              <!-- Row 5 -->
              <div class="row memgal clearfix">
                <!--======================
                            MEMBER
                ==========================-->
                <div class="memberMain pull-left">
                  <h4 class="categoryHeader"><span class="category memberTitle">Member</span></h4>
                  <div class="block">
                    <div class="col-sm-6">
                      <div class="memberBigpic">
                        <a href="#"><img src="images/contents_member_001.jpg" alt=""/></a>
                      </div>
                      <div class="memberName">
                        <h3><a>Arif Lutfhansah</a></h3>
                      </div>
                      <div class="memberPosition">
                        <span class="metaInfo">Chief Executive Officer</span>
                      </div>
                      ...
                      <div class="memberBigpic">
                        <a href="#"><img src="images/contents_member_002.jpg" alt=""/></a>
                      </div>
                      <div class="memberName">
                        <h3><a>Adven Tonny</a></h3>
                      </div>
                      <div class="memberPosition">
                        <span class="metaInfo">Chief Operating Officer</span>
                      </div>
                      <div class="memberDetail"> 
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="memberSmall block clearfix">
                        <div class="memberSmallpic pull-left">
                          <a href="#"><img src="images/contents_member_002.jpg" alt=""/></a>
                        </div>
                        <div class="memberName pull-right">
                          <h3><a href="#">Adven Tonny</a></h3>
                          <div class="memberPosition">
                            <span class="metaInfo">Chief Operating Officer</span>
                          </div>
                          <div class="memberDetail"> 
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing<a href="#"> more...</a></p>
                          </div>
                        </div>
                      </div>
                      <div class="memberSmall block clearfix">
                        <div class="memberSmallpic pull-left">
                          <a href="#"><img src="images/contents_member_003.jpg" alt=""/></a>
                        </div>
                        <div class="memberName pull-right">
                          <h3><a href="#">Bobby Pratama</a></h3>
                          <div class="memberPosition">
                            <span class="metaInfo">Chief Operating Officer</span>
                          </div>
                          <div class="memberDetail"> 
                      ...
                      <div class="memberSmall block clearfix">
                        <div class="memberSmallpic pull-left">
                          <a href="#"><img src="images/contents_member_004.jpg" alt=""/></a>
                        </div>
                        <div class="memberName pull-right">
                          <h3><a href="#">Ardian Saputra</a></h3>
                          <div class="memberPosition">
                            <span class="metaInfo">Chief Operating Officer</span>
                          </div>
                          <div class="memberDetail"> 
                      ...
                      <div class="memberSmall block clearfix">
                        <div class="memberSmallpic pull-left">
                          <a href="#"><img src="images/contents_member_005.jpg" alt=""/></a>
                        </div>
                        <div class="memberName pull-right">
                          <h3><a href="#">Iqbal</a></h3>
                          <div class="memberPosition">
                            <span class="metaInfo">Chief Operating Officer</span>
                          </div>
                          <div class="memberDetail"> 
                ...
                <!--======================
                          GALLERY
                ==========================-->
                <div class="galleryMain pull-right">
                  <h4 class="categoryHeader"><span class="category galleryTitle">Gallery</span></h4>
                  <div class="galleryCategory block">
                    <input type="radio" id="all" name="button">
                      <label for="all" class="label-all label-active">All</label>
                    <input type="radio" id="gath" name="button">
                      <label for="gath" class="label-gath">Gathering</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Sakurai Matsuri</label>
                    <input type="radio" id="jjm" name="button">
                      <label for="jjm" class="label-jjm">Jak Japan Matsuri</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Jiyuu Matsuri</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Ennichisai</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Gelar Jepang UI</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">AFA</label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Blok M Matsuri </label>
                    <input type="radio" id="select-desert" name="button">
                      <label for="select-desert" class="label-desert">Japan Festival</label>
                  </div>

                  <ul class="gallery">
                    <li class="gath-item">
                      <a href="#"><img src="images/contents_gallery_001.jpg" /></a>
                    </li>
                    <li class="jjm-item">
                      <a href="#"><img src="images/contents_gallery_002.jpg" /></a>
                    </li>
                    <li class="jjm-item">
                      <a href="#"><img src="images/contents_gallery_003.jpg" /></a>
                    </li>
                    <li class="desert-item">
                      <a href="#"><img src="images/contents_gallery_004.jpg" /></a>
                    </li>
                    <li class="animals-item">
                      <a href="#"><img src="images/contents_gallery_005.jpg" /></a>
                    </li>
                    <li class="animals-item">
                      <a href="#"><img src="images/contents_gallery_006.jpg" /></a>
                    </li>
                    <li class="jjm-item">
                      <a href="#"><img src="images/contents_gallery_007.jpg" /></a>
                    </li>
                    <li class="animals-item">
                      <a href="#"><img src="images/contents_gallery_008.jpg" /></a>
                    </li>
                    <li class="lightning-item">
                      <a href="#"><img src="images/contents_gallery_009.jpg" /></a>
                    </li>
                    <li class="jjm-item">
                      <a href="#"><img src="images/contents_gallery_010.jpg" /></a>
                    </li>
                    <li class="gath-item">
                      <a href="#"><img src="images/contents_gallery_011.jpg" /></a>
                    </li>
                    <li class="lightning-item">
                      <a href="#"><img src="images/contents_gallery_012.jpg" /></a>
                    </li>
                    <li class="gath-item">
                      <a href="#"><img src="images/contents_gallery_013.jpg" /></a>
                    </li>
                    <li class="lightning-item">
                      <a href="#"><img src="images/contents_gallery_014.jpg" /></a>
                    </li>
                    <li class="gath-item">
                      <a href="#"><img src="images/contents_gallery_015.jpg" /></a>
                    </li>
                    <li class="animals-item">
                      <a href="#"><img src="images/contents_gallery_016.jpg" /></a>
                    </li>
                  </ul>
